...
parameter trpopt;
trpopt(r)=sam2(r,"27","57");
display trpopt;


parameter trpfrt;
trpfrt(r)=sum(j$(ord(j)<=30),sam2(r,"57",j));
display trpfrt;


parameter trphh;
trphh(r)=sum(j$(ord(j)=63),sam2(r,"57",j));
display trphh;

parameter mvhhh;
mvhhh(r)=sum(j$(ord(j)=63),sam2(r,"47",j));
display mvhhh;
...
parameter totegy;
totegy("coal")=sum(r,ebt("coal",r,"37")+ebt("coal",r,"3")+ebt("coal",r,"4")
-ebt("coal",r,"1")-ebt("coal",r,"2")-ebt("coal",r,"15")-ebt("coal",r,"28"));
		 
totegy("oil")=sum(r,ebt("oil",r,"37")+ebt("oil",r,"3")+ebt("oil",r,"4")
-ebt("oil",r,"1")-ebt("oil",r,"2")-ebt("oil",r,"15")-ebt("oil",r,"28"));
		 
totegy("ng")=sum(r,ebt("ng",r,"37")+ebt("ng",r,"3")+ebt("ng",r,"4")
-ebt("ng",r,"1")-ebt("ng",r,"2")-ebt("ng",r,"15")-ebt("ng",r,"28"));
	       	 
totegy("roil")=sum(r,ebt("roil",r,"37")+ebt("roil",r,"3")+ebt("roil",r,"4")
-ebt("roil",r,"1")-ebt("roil",r,"2"));
	       	 
totegy("fg")=sum(r,ebt("fg",r,"37")+ebt("fg",r,"3")+ebt("fg",r,"4")
-ebt("fg",r,"1")-ebt("fg",r,"2"));
		 
parameter totco2;
totco2("coal")=  totegy("coal")	*2.66;
totco2("oil") =	 totegy("oil")	*2.02;
totco2("ng")  =  totegy("ng")	*1.47;
totco2("roil")=  totegy("roil")	*2.02;
totco2("fg")  =	 totegy("fg")	*1.47;

parameter totco2chn;
totco2chn=sum(e,totco2(e));
display totco2chn;
...
*COLUMN calibration
*intinput: intermediate input
loop(r,
loop(i$(((ord(i)>=31) and (ord(i)<=60)) and (ord(i)<>33) and (ord(i)<>60)),
temp= sam3(r,i,"3");
sam3(r,i,"3")$(poilng*ebt("OIL",r,"37")+ebt("NG",r,"37")>0)=temp*poilng*ebt("OIL",r,"37")/(poilng*ebt("OIL",r,"37")+ebt("NG",r,"37"));
sam3(r,i,"30")$(poilng*ebt("OIL",r,"37")+ebt("NG",r,"37")>0)=temp*ebt("NG",r,"37")/(poilng*ebt("OIL",r,"37")+ebt("NG",r,"37"));
);
);
*othinput: labor, capital and other tax
loop(r,
loop(i$((ord(i)>=61) and (ord(i)<=69)),
temp=sam3(r,i,"3");
sam3(r,i,"30")$(poilng*ebt("OIL",r,"37")+ebt("NG",r,"37"))=temp*ebt("NG",r,"37")/(poilng*ebt("OIL",r,"37")+ebt("NG",r,"37"));
...
loop(r,
loop(i$((ord(i)>=31) and (ord(i)<=60) and (sumcolumn(r,i)/totoutput(r)<0.005) and not(((ord(i)=32) or (ord(i)=33) or (ord(i)=41) or (ord(i)=47) or (ord(i)=53) or (ord(i)=54) or (ord(i)=55) or (ord(i)=60)))),
...
parameter egyconsi(i,r),egycons(r),egyconschn;
egyconsi(i,r) = sum(ebti$((ord(ebti)>4) and (ord(ebti)<37) and (ord(ebti)<>6) and (ord(ebti)<>7) and (ord(ebti)<>15) and (ord(ebti)<>28) and (ord(ebti)<>34)),
ebt2(i,r,ebti));

egycons(r)=sum(i,egyconsi(i,r)) + (ebt2("23",r,"3")-ebt2("23",r,"1"))*0.33 * 0.71 /0.1229;

egyconschn=sum(r,egycons(r));

display egyconsi,egycons,egyconschn;
$exit
