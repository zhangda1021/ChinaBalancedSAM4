...
*	Scale data:
parameter scalegtap /100/;
*	GTAPinGAMS data is in million$. Hence, the model is in million$/scalegtap.

vom(g,r) = vom(g,r)/scalegtap;
vdfm(i,g,r)	 = vdfm(i,g,r)	/scalegtap;
vifm(i,g,r)	 = vifm(i,g,r)	/scalegtap;
vfm(f,g,r)	 = vfm(f,g,r)	/scalegtap;
vtw(j) = vtw(j)/scalegtap;
vst(j,r) = vst(j,r)/scalegtap;
vim(i,r) = vim(i,r)/scalegtap;
vxmd(i,s,r)	 = vxmd(i,s,r)	/scalegtap;
vtwr(j,i,s,r)  = vtwr(j,i,s,r) /scalegtap;
evom(f,r) = evom(f,r)/scalegtap;
vb(r) = vb(r)/scalegtap;

*$exit
vom(g,r)$(vom(g,r) lt 1e-8) = 0;
vdfm(i,g,r)$(vdfm(i,g,r) lt 1e-8) = 0;
vifm(i,g,r)$(vifm(i,g,r) lt 1e-8) = 0;
vfm(f,g,r)$(vfm(f,g,r) lt 1e-8) = 0;
vtw(j)$(vtw(j) lt 1e-8) = 0;
vst(j,r)$(vst(j,r) lt 1e-8) = 0;
vim(i,r)$(vim(i,r) lt 1e-8) = 0;
vxmd(i,s,r)$(vxmd(i,s,r) lt 1e-8) = 0;
vtwr(j,i,s,r)$(vtwr(j,i,s,r) lt 1e-8) = 0;
evom(f,r)$(evom(f,r) lt 1e-8) = 0;
*vb(r)$(vb(r) lt 1e-8) = 0;
